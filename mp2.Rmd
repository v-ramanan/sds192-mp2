...
Hypothesis:
1. 
  a. It is expected that the Democrats will win the most number of votes in the general elections as New York is a historically blue state.
  b. However, the margin of votes between the Republicans and Democrats would be small because political analysts note that support for the party in power often dwindles during a president’s second term (citation needed).
  c. Libertarians and conservatives will garner more votes than other third parties because mainstream political media is more focused on them. 
